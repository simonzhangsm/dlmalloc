/*
 This is an updated version (aka dlmalloc) of malloc/free/realloc modified by
 Dr. Shiming (Simon) Zhang (smzhang@me.com), based on dlmalloc writted by
...
/*Automatically Get CACHE_LINE_SIZE and PAGE_SIZE
 *Added by Simon Zhang @ simon.zhangsm@gmail.com
 */
...
static inline uint64_t read_tsc(void){
    ...
    return ((uint64_t)lo) | (((unsigned long) hi) << 32);
}
...
static inline void cpuid(size_t *eax, size_t *ebx, size_t *ecx, size_t *edx){
    __asm__ __volatile__(
                         "cpuid"
...
#define MAX_SIZE_T           (~(size_t)0)
	...
	#define USE_LOCKS  ((defined(USE_SPIN_LOCKS) && USE_SPIN_LOCKS != 0) || \
		(defined(USE_RECURSIVE_LOCKS) && USE_RECURSIVE_LOCKS != 0))
			...
			defined(__i386__) || defined(__x86_64__))) || (defined(_MSC_VER) && _MSC_VER>=1310))
...
#define SIZE_T_BITSIZE      (sizeof(size_t) << 3) //sizeof(size_t)*8
...
#define align_offset(A) \
	(is_aligned(A)? 0 : ((MALLOC_ALIGNMENT - ((size_t)(A) & CHUNK_ALIGN_MASK)) & CHUNK_ALIGN_MASK))
